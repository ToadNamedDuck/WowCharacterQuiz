...
export class PlayableClass {
  ...
  constructor(className, classIconLocation, combatPosition, lotOfButtons, isFlexibleBool, canHealBool){
    this.name = className;
...
const DeathKnight = new PlayableClass("Death Knight", "CLASS_Death-Knight.png", Position.Melee, LotsOfButtons.Yes, false, false);
const DemonHunter = new PlayableClass("Demon Hunter", "CLASS_Demon-Hunter.png", Position.Melee, LotsOfButtons.No, false, false);
const Druid = new PlayableClass("Druid", "CLASS_Druid.png", Position.Both, LotsOfButtons.Yes, true, true);
const Evoker = new PlayableClass("Evoker", "CLASS_Evoker.png", Position.Ranged, LotsOfButtons.SpecDependent, false, true);
const Hunter = new PlayableClass("Hunter", "CLASS_Hunter.png", Position.Both, LotsOfButtons.SpecDependent, false, false);
...
const Warrior = new PlayableClass("Warrior", "CLASS_Warrior.png", Position.Melee, LotsOfButtons.SpecDependent, false, false);
...
const Human = new PlayableRace("Human", "RACE_Human-M.png", [...nearlyUniversalClasses, Paladin], Faction.Alliance, false, true);
const KulTiran = new PlayableRace("Kul Tiran Human", "RACE_Kul-Tiran-M.png", [...nearlyUniversalClasses, Druid, Shaman], Faction.Alliance, false, true);
const LightforgedDraenei = new PlayableRace("Lightforged Draenei", "RACE_Lightforged-Draenei-M.png", [...nearlyUniversalClasses, Paladin], Faction.Alliance, false, true);
const MagharOrc = new PlayableRace("Mag'har Orc", "RACE_Maghar-Orc-M.png", [...nearlyUniversalClasses, Shaman], Faction.Horde, false, true);
const Mechagnome = new PlayableRace("Mechagnome", "RACE_Mechagnome-M.png", [...nearlyUniversalClasses], Faction.Alliance, false, false);
const NightElf = new PlayableRace("Night Elf", "RACE_Night-Elf-M.png", [...nearlyUniversalClasses, Druid, DemonHunter], Faction.Alliance, false, true);
const Nightborne = new PlayableRace("Nightborne", "RACE_Nightborne-M.png", [...nearlyUniversalClasses], Faction.Horde, false, true);
const Orc = new PlayableRace("Orc", "RACE_Orc-M.png", [...nearlyUniversalClasses, Shaman], Faction.Horde, false, true);
const Pandaren = new PlayableRace("Pandaren", "RACE_Pandaren-M.png", [...nearlyUniversalClasses, Shaman], Faction.Both, true, true);
const Tauren = new PlayableRace("Tauren", "RACE_Tauren-M.png", [...nearlyUniversalClasses, Paladin, Shaman, Druid], Faction.Horde, true, true);
const Troll = new PlayableRace("Troll", "RACE_Troll-M.png", [...nearlyUniversalClasses, Druid, Shaman], Faction.Horde, false, true);
const Undead = new PlayableRace("Undead", "RACE_Undead-M.png", [...nearlyUniversalClasses], Faction.Horde, false, true);
const VoidElf = new PlayableRace("Void Elf", "RACE_Void-Elf-M.png", [...nearlyUniversalClasses], Faction.Alliance, false, true);
const Worgen = new PlayableRace("Worgen", "RACE_Worgen-M.png", [...nearlyUniversalClasses, Druid], Faction.Alliance, true, true);
const Vulpera = new PlayableRace("Vulpera", "RACE_Vulpera-M.png", [...nearlyUniversalClasses, Shaman], Faction.Horde, true, false);
const ZandalariTroll = new PlayableRace("Zandalari Troll", "RACE_Zandalari-Troll-M.png", [...nearlyUniversalClasses, Druid, Paladin, Shaman], Faction.Horde, false, true);
