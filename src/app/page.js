...
class PlayableClass {
  ...
  constructor(className, classIconLocation, combatPosition, arrayOfInvalidationAnswers, lotOfButtons, isShinyBool, isFlexibleBool, canHealBool){
    this.name = className;
    this.icon = classIconLocation;
    this.position = combatPosition;
    this.invalidationAnswers = arrayOfInvalidationAnswers;
...
class PlayableRace {
  ...
  constructor(raceName, raceIconLocation, classArray, arrayOfInvalidationAnswers, faction, isShinyBool, isHairyBool, isTallBool){
    this.name = raceName;
...
const BloodElf = new PlayableRace("Blood Elf", "RACE_Blood-Elf-M.png", [...nearlyUniversalClasses, Paladin, DemonHunter], [0, null, null, 1, 0, 1, null], Faction.Horde, true, false, true);
const DarkIronDwarf = new PlayableRace("Dark Iron Dwarf", "RACE_Dark-Iron-Dwarf-M.png", [...nearlyUniversalClasses, Paladin, Shaman], [1, null, null, null, 1, 0, null], Faction.Alliance, false, true, false);
const Dracthyr = new PlayableRace("Dracthyr", "RACE_Dracthyr-M.png", [Evoker], [null, 1, null, 1, 0, 1, 0], Faction.Both, true, false, true);
const Draenei = new PlayableRace("Draenei", "RACE_Draenei-M.png", [...nearlyUniversalClasses, Paladin, Shaman], [1, null, null, 1, 0, 1, null], Faction.Alliance, true, false, true);
const Dwarf = new PlayableRace("Dwarf", "RACE_Dwarf-M.png", [...nearlyUniversalClasses, Paladin, Shaman], [1, null, null, null, 1, 0, null], Faction.Alliance, false, true, false);
const Gnome = new PlayableRace("Gnome", "RACE_Gnome-M.png", [...nearlyUniversalClasses], [1, null, null, null, 0, 0, null], Faction.Alliance, false, false, false);
const Goblin = new PlayableRace("Goblin", "RACE_Goblin-M.png", [...nearlyUniversalClasses, Shaman], [0, null, null, 0, 0, 0, null], Faction.Horde, false, false, false);
const HighmountainTauren = new PlayableRace("Highmountain Tauren", "RACE_Highmountain-Tauren-M.png", [...nearlyUniversalClasses, Druid, Shaman], [0, null, null, 0, 1, 1, null], Faction.Horde, false, true, true);
const Human = new PlayableRace("Human", "RACE_Human-M.png", [...nearlyUniversalClasses, Paladin], [1, null, null, null, 0, 1, null], Faction.Alliance, true, false, true);
const KulTiran = new PlayableRace("Kul Tiran Human", "RACE_Kul-Tiran-M.png", [...nearlyUniversalClasses, Druid, Shaman], [1, null, null, 0, 0, 1, null], Faction.Alliance, false, false, true);
const LightforgedDraenei = new PlayableRace("Lightforged Draenei", "RACE_Lightforged-Draenei-M.png", [...nearlyUniversalClasses, Paladin], [1, null, null, 1, 0, 1, null], Faction.Alliance, true, false, true);
const MagharOrc = new PlayableRace("Mag'har Orc", "RACE_Maghar-Orc-M.png", [...nearlyUniversalClasses, Shaman], [0, null, null, 0, 0, 1, null], Faction.Horde, false, false, true);
const Mechagnome = new PlayableRace("Mechagnome", "RACE_Mechagnome-M.png", [...nearlyUniversalClasses], [1, null, null, 1, 0, 0, null], Faction.Alliance, true, false, false);
const NightElf = new PlayableRace("Night Elf", "RACE_Night-Elf-M.png", [...nearlyUniversalClasses, Druid, DemonHunter], [1, null, null, null, null, 1, null], Faction.Alliance, false, false, true);
const Nightborne = new PlayableRace("Nightborne", "RACE_Nightborne-M.png", [...nearlyUniversalClasses], [0, null, null, 1, 0, 1, null], Faction.Horde, true, false, true);
const Orc = new PlayableRace("Orc", "RACE_Orc-M.png", [...nearlyUniversalClasses, Shaman], [0, null, null, 0, 0, 1, null], Faction.Horde, false, false, true);
const Pandaren = new PlayableRace("Pandaren", "RACE_Pandaren-M.png", [...nearlyUniversalClasses, Shaman], [null, null, null, null, 1, 1, null], Faction.Both, false, true, true);
const Tauren = new PlayableRace("Tauren", "RACE_Tauren-M.png", [...nearlyUniversalClasses, Paladin, Shaman, Druid], [0, null, null, 0, 1, 1, null], Faction.Horde, false, true, true);
const Troll = new PlayableRace("Troll", "RACE_Troll-M.png", [...nearlyUniversalClasses, Druid, Shaman], [0, null, null, null, 0, 1, null], Faction.Horde, false, false, true);
const Undead = new PlayableRace("Undead", "RACE_Undead-M.png", [...nearlyUniversalClasses], [0, null, null, 0, 0, 1, null], Faction.Horde, false, false, true);
const VoidElf = new PlayableRace("Void Elf", "RACE_Void-Elf-M.png", [...nearlyUniversalClasses], [1, null, null, 1, 0, 1, null], Faction.Alliance, true, false, true);
const Worgen = new PlayableRace("Worgen", "RACE_Worgen-M.png", [...nearlyUniversalClasses, Druid], [1, null, null, null, 1, 1, null], Faction.Alliance, false, true, true);
const Vulpera = new PlayableRace("Vulpera", "RACE_Vulpera-M.png", [...nearlyUniversalClasses, Shaman], [0, null, null, null, 1, 0, null], Faction.Horde, false, true, false);
const ZandalariTroll = new PlayableRace("Zandalari Troll", "RACE_Zandalari-Troll-M.png", [...nearlyUniversalClasses, Druid, Paladin, Shaman], [0, null, null, 1, 0, 1, null], Faction.Horde, true, false, true);
